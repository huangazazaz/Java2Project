...
public class javascript {
  ...
  public String issues() throws IOException {
    String url1 = "https://api.github.com/repos/kubernetes-client/javascript/issues?state=all&per_page=100";
  ...
  public String commits() throws IOException {
    String url1 = "https://api.github.com/repos/kubernetes-client/javascript/commits?per_page=100";
