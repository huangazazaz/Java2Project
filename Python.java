...
public class Python {
  ...
  public String issues() throws IOException {
    String url1 = "https://api.github.com/repos/google/python-fire/issues?state=all&per_page=100";
  ...
  public String commits() throws IOException {
    String url1 = "https://api.github.com/repos/google/python-fire/commits?per_page=100";
