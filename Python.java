...
public class Python {
  ...
  public JSONArray issues() throws IOException {
    String url1 = "https://api.github.com/repos/google/python-fire/issues";
...
//        Execute a command in PowerShell session
  ...
  public JSONArray commits() throws IOException {
    String url1 = "https://api.github.com/repos/google/python-fire/commits";
  ...
  public JSONArray contributors() throws IOException {
    String url1 = "https://api.github.com/repos/google/python-fire/contributors";
  ...
  public JSONArray releases() throws IOException {
    String url1 = "https://api.github.com/repos/google/python-fire/releases";
