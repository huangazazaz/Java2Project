...
public class mybatis {
  ...
  public String issues() throws IOException {
    String url1 = "https://api.github.com/repos/mybatis/mybatis-3/issues?state=all&per_page=100";
  ...
  public String commits() throws IOException {
    String url1 = "https://api.github.com/repos/mybatis/mybatis-3/commits?per_page=100";
